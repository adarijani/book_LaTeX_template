...
\chapter{TRIGONOMETRIC SERIES AND FOURIER SERIES. AUXILIARY RESULTS}
...
\noindent Here $x$ is a real variable and \textit{coefficients} $a_0,a_1,b_1,\dots$ are independent 
of $x$. We may usually suppose, if we wish , that the coefficients are real; when they 
are complex.
